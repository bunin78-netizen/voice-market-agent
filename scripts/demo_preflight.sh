...
cat <<'EOT'
  1) голосом:  «Что с биткоином на четырёхчасовом?»   ← на 0:25
  2) голосом:  «Покажи дневной график эфира»   ← так распознаётся надёжнее
  3) голосом:  «А что по настроению рынка?»   ← на 2:30
EOT
echo
