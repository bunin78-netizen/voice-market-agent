...
- **Видео-демо:** `~/Videos/voice-market-DEMO.mp4` — 2:58, 1360×722, закадровая озвучка моделью + голос бота из архива; английские субтитры — `~/Videos/voice-market-DEMO.en.srt` (тайминги сняты с самого видео; загрузить на YouTube отдельно)
