...
- **Видео-демо:** `~/Videos/voice-market-DEMO.mp4` — 2:58, 1360×722, закадровая озвучка моделью + голос бота из архива; английские субтитры — `docs/demo-subtitles-en.srt` (загрузить на YouTube отдельно)
