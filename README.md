...
Бот работает: **[@VoiceMarketAgentBot](https://t.me/VoiceMarketAgentBot)**

1. Нажми Start.
2. Отправь голосовое: «что с биткоином на четырёхчасовом?»
3. Или: «покажи график эфира за день».

Ответ приходит текстом, графиком и голосовым сообщением.

## Замеры на живых ключах

| Шаг | Время | Что происходит |
|---|---|---|
| Распознавание (AssemblyAI) | 6.1 c | голосовое 51 с, русский, авто-детект языка |
| Агент (LLM + инструменты) | 3.8 c | сам вызвал `get_indicators` по BTC и SOL |
| Синтез речи (ElevenLabs REST) | 0.7 c | модель `eleven_flash_v2_5` |
| **Итого** | **~11 c** | от голосового до голосового ответа |
